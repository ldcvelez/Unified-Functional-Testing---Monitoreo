...
RunAction "Cuentas [MonitoreoBIP]", oneIteration

RunAction "Seguros [MonitoreoBIP]", oneIteration

RunAction "Tarjetas [MonitoreoBIP]", oneIteration

RunAction "Beneficios [MonitoreoBIP]", oneIteration

RunAction "Pagos [MonitoreoBIP]", oneIteration

RunAction "Inversiones [MonitoreoBIP]", oneIteration

'RunAction "Transferencias [MonitoreoBIP]", oneIteration

RunAction "Prestamos [MonitoreoBIP]", oneIteration

RunAction "MiFi [MonitoreoBIP]", oneIteration
